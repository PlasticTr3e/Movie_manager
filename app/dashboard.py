...
class Dashboard(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.button_add_watchlist = ctk.CTkButton(button_frame, text="Watchlist", command=self.add_watchlist, width=100, height=40, corner_radius=10)
        ...
        self.button_add_watchlist.pack(side=ctk.LEFT, padx=5, pady=5)
        ...
        self.logout_button = ctk.CTkButton(self.bg_label, text="Logout", command=self.logout, width=100, height=40, corner_radius=10)
        self.logout_button.place(relx=0.9, rely=0.15, anchor="center")
        
    #Load movies ke dalam table
    ...
    #Load reviews ke dalam table didapatkan berdasarkan movie_title yang didapatkan
    ...
    #Menambahkan Movie
    def add_movie(self):
        self.controller.show_frame("Movie", callback=self.load_movies) #Pindah ke class Movie dengan callback ke load_movies
