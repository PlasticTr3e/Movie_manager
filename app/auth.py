...
class Auth(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.bg = CTkImage(Image.open(r"BG\BG6.png"), size=(1200, 600))
        ...
        self.welcome_label = ctk.CTkLabel(login_form_frame, text="Start Reviewing Here.", font=("Arial", 24), text_color="#333333", bg_color="transparent")
...
class Register(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        login_form_frame = ctk.CTkFrame(self.bg_label, fg_color="#f0f0f0", bg_color="#22333e", corner_radius=20)
        login_form_frame.place(relheight = 0.7, relwidth= 0.38, relx=0.5, rely=0.51, anchor="center")

    
        self.entry_username = ctk.CTkEntry(self.bg_frame, width=300, height=40,  placeholder_text="Username", bg_color="#FFFFFF", corner_radius=20)
        self.entry_username.place(relx=0.5, rely=0.24, anchor="center")

       
        self.entry_email = ctk.CTkEntry(self.bg_frame, width=300, height=40,  placeholder_text="Email", bg_color="#FFFFFF", corner_radius=20)
        self.entry_email.place(relx=0.5, rely=0.34, anchor="center")

        
        self.entry_password = ctk.CTkEntry(self.bg_frame, width=300, height=40,  placeholder_text="Password", show="*", bg_color="#FFFFFF", corner_radius=20)
        self.entry_password.place(relx=0.5, rely=0.44, anchor="center")

        
        self.entry_confirm_password = ctk.CTkEntry(self.bg_frame, width=300, height=40,  placeholder_text="Confirm Password", show="*", bg_color="#FFFFFF", corner_radius=20)
        self.entry_confirm_password.place(relx=0.5, rely=0.54, anchor="center")

        
        self.button_register = ctk.CTkButton(self.bg_frame, text="Register", width=200, height=40,  command=self.register, bg_color="#FFFFFF", corner_radius=20)
        self.button_register.place(relx=0.5, rely=0.68, anchor="center")

      
        self.button_back = ctk.CTkButton(self.bg_frame, text="Back to Login", width=200, height=40,  command=self.back_to_login, bg_color="#FFFFFF", corner_radius=20)
